...
public class Rope : Node
{
    ...
    public List<RopeSegment> allRopeSegments;
    // each segment length
    const double segmentLength = 16.0;

    PackedScene RopeSegment = (PackedScene)ResourceLoader.Load("res://screens/gameScreen/bridge/RopeSegment.tscn");
    ...
    public override void _Ready()
    {
        ...
        allRopeSegments = new List<RopeSegment>();
        rand = new Random();
    }
