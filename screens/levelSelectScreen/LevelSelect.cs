...
public class LevelSelect : Control
{
    ...
    public PackedScene LevelButton = (PackedScene)ResourceLoader.Load("res://global/button/LevelButton.tscn");
    ...
    private void CreateLevelButton(string levelScene, string levelName)
    {
        ...
        button.Icon = (Texture)ResourceLoader.Load("res://screens/levelSelectScreen/assets/buttonIcons/" + tempText + ".png");
